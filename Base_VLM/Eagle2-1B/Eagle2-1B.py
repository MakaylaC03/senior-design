...
if __name__ == '__main__':
    ...
    prompt = [
        ...
        {'role': 'user', 'content': 'Describe this image in details.', 
            'image':[
                {'url': 'https://imgs.search.brave.com/z9BezKZBcWejpYNi856L9qscxGVPoU4Qy-o_NLZdD4c/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly9pMC53/cC5jb20vbWlkd2Vz/dG5vbWFkcy5jb20v/d3AtY29udGVudC91/cGxvYWRzLzIwMjMv/MDUvR2lhbnRDaXR5/U3RhdGVQYXJrMjAy/My02MS1vZi0xMTkt/c2NhbGVkLmpwZz9m/aXQ9OTYwLDY0MCZz/c2w9MQ'}
            ]
        }
    ]
    params = {
